...
@section('content')
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Ajouter une mesure</h6>
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Ajouter une mesure</li>
            </ul>
        </div>
                    ...
                    <div class="col-xxl-12 col-xl-12 col-lg-12">
                        <div class="card border">
                            <div class="card-body">
                                ...
                                <form action="{{ route('client.mesure.store') }}" method="POST">
                                    @csrf
                                    <div class="row mb-20">
                                        <div class="col-sm-3">
                                            <div class="mb-20">
                                                ...
                                                <select class="form-control radius-8 form-select" required  name="sexe" id="sexe">
                                                    <option value="{{ env('SEXE_MASCULIN') }}" {{ old('sexe') == env('SEXE_MASCULIN') ? 'selected' : '' }}>{{ env('SEXE_MASCULIN') }}</option>
                                                    <option value="{{ env('SEXE_FEMININ') }}" {{ old('sexe') == env('SEXE_FEMININ') ? 'selected' : '' }}>{{ env('SEXE_FEMININ') }}</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="mb-20">
                                                ...
                                                <input type="text" class="form-control radius-8" value="{{old('epaule')}}" name="epaule" >
                                                <input type="hidden" class="form-control radius-8" value="{{ $client->id }}" name="client_id" >
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="mb-20">
                                                <label for="longueur_epaule" class="form-label fw-semibold text-primary-light text-sm mb-8">Largeur Epaule </label>
                                                <input type="text" class="form-control radius-8" value="{{old('longueur_epaule')}}" name="longueur_epaule" >
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="mb-20">
                                                <label for="carrure" class="form-label fw-semibold text-primary-light text-sm mb-8">Carrure </label>
                                                <input type="text" class="form-control radius-8" value="{{old('carrure')}}" name="carrure" >
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="mb-20">
                                                <label for="poitrine" class="form-label fw-semibold text-primary-light text-sm mb-8">Poitrine</label>
                                                <input type="text" class="form-control radius-8" value="{{old('poitrine')}}" name="poitrine" >
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="mb-20">
                                                <label for="dos" class="form-label fw-semibold text-primary-light text-sm mb-8">Dos</label>
                                                <input type="text" class="form-control radius-8" value="{{old('dos')}}" name="dos" >
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="mb-20">
                                                <label for="tour_taille" class="form-label fw-semibold text-primary-light text-sm mb-8">Tour de Taille</label>
                                                <input type="text" class="form-control radius-8" value="{{old('tour_taille')}}" name="tour_taille" >
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="mb-20">
                                                <label for="ceinture" class="form-label fw-semibold text-primary-light text-sm mb-8">Ceinture </label>
                                                <input type="text" class="form-control radius-8" value="{{old('ceinture')}}" name="ceinture" >
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="mb-20">
                                        ...
                                        <div class="col-sm-3" id="sexe_feminin1">
                                            <div class="mb-20">
                                                ...
                                                <input type="text" class="form-control radius-8" value="{{old('longueur_jupe')}}" name="longueur_jupe" >
                                            </div>
                                        </div>
                                        ...
                                        <div id="sexe_feminin" class="row">
                                            <div class="col-sm-3">
                                                <div class="mb-20">
                                                    ...
                                                    <input type="text" class="form-control radius-8" value="{{old('ecart_pince_poitrine')}}" name="ecart_pince_poitrine" >
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="mb-20">
                                                    <label for="longueur_haut" class="form-label fw-semibold text-primary-light text-sm mb-8">Longueur haut</label>
                                                    <input type="text" class="form-control radius-8" value="{{old('longueur_haut')}}" name="longueur_haut" >
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="mb-20">
                                                    <label for="longueur_robe" class="form-label fw-semibold text-primary-light text-sm mb-8">Longueur Robe</label>
                                                    <input type="text" class="form-control radius-8" value="{{old('longueur_robe')}}" name="longueur_robe" >
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="mb-20">
                                                    <label for="hauteur_poitrine" class="form-label fw-semibold text-primary-light text-sm mb-8">Hauteur Poitrine </label>
                                                    <input type="text" class="form-control radius-8" value="{{old('hauteur_poitrine')}}" name="hauteur_poitrine" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
