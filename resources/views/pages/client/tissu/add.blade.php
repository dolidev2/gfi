...
@section('content')
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Ajouter un tissu</h6>
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Ajouter un tissu</li>
            </ul>
        </div>
                    ...
                    <div class="col-xxl-12 col-xl-12 col-lg-12">
                        <div class="card border">
                            <div class="card-body">
                                ...
                                <form action="{{ route('client.tissu.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row mb-20">
                                        ...
                                        <div class="row" id="acheter-row">
                                            <div class="col-sm-4">
                                                <div class="mb-20">
                                                    ...
                                                    <input type="number" step="0.01" class="form-control radius-8" value="{{old('quantite')}}" name="quantite" >
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="mb-20">
                                                    <label for="prix" class="form-label fw-semibold text-primary-light text-sm mb-8">Prix </label>
                                                    <input type="number" step="0.01" class="form-control radius-8" value="{{old('prix')}}" name="prix" >
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="mb-20">
                                                    <label for="commission" class="form-label fw-semibold text-primary-light text-sm mb-8">Commission </label>
                                                    <input type="number" step="0.01" class="form-control radius-8" value="{{old('commission')}}" name="commission" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
